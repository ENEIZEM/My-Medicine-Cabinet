...
export default function WelcomeScreen({ onReady }: WelcomeScreenProps) {
  ...
  return (
    <View style={[commonStyles.centered, { backgroundColor: colors.background }]}>
      <Animated.View style={fadeStyle} entering={FadeIn.duration(300)}>
        <Icon source="heart" size={80} color={colors.primary} />
      </Animated.View>

      <Animated.View style={fadeStyle} entering={FadeIn.delay(100).duration(300)}>
      ...
      {!!userName && (
        <Animated.View style={fadeStyle} entering={FadeIn.delay(200).duration(300)}>
